...
RUN --mount=type=cache,id=s/c16f4908-4f5f-430a-a55a-64edadda23a4-var-cache-apt,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=s/c16f4908-4f5f-430a-a55a-64edadda23a4-var-lib-apt-lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
  && apt-get upgrade -y \
...
# broken image.
RUN --mount=type=cache,id=s/c16f4908-4f5f-430a-a55a-64edadda23a4-root-.npm,target=/root/.npm \
...
COPY . ./
RUN --mount=type=cache,id=s/c16f4908-4f5f-430a-a55a-64edadda23a4-app-.build-next-cache,target=/app/.build/next/cache \
...
RUN --mount=type=cache,id=s/c16f4908-4f5f-430a-a55a-64edadda23a4-var-cache-apt,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/c16f4908-4f5f-430a-a55a-64edadda23a4-var-lib-apt-lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
